            ...
            <v-dialog v-model="addModalShow" max-width="500px">
                <v-card>
                    <v-card-text>
                        <div class="mb-6 d-flex justify-space-between">
                            <div>
                                ...
                                <p class="textSecondary text-14">
                                    Fill in the title, choose the event color, and select the start and end dates to add an event.
                                </p>
                            </div>
                        ...
                        <v-text-field v-model="newEvent.end" variant="outlined" hide-details type="date" class="mb-5" required />
                        ...
                        <!-- Add Event Button -->
                        <v-btn @click="addEvent" color="primary" class="mt-6">Add Event</v-btn>
                    </v-card-text>
                </v-card>
            </v-dialog>
            ...
            <v-dialog v-model="updateModalShow" max-width="500px">
                <v-card>
                    <v-card-text>
                        ...
                        <v-btn @click="updateEvent" color="primary" class="mt-6"> Update Event </v-btn>

                        <v-btn @click="deleteEvent" color="error" class="mt-6 ms-4"> Delete Event </v-btn>
                    </v-card-text>
                </v-card>
            </v-dialog>
        </div>
