...
const chartOptions = computed(() => {
    return {
        ...
        colors: ['rgba(var(--v-theme-primary))', 'rgba(var(--v-theme-secondary))', '#EAEFF4'],
        grid: {
            show: false
        },
        plotOptions: {
...
<template>
    <v-card elevation="10">
        <v-card-item class="pb-7">
            ...
            <div class="ml-n2">
                <apexchart class="mt-5 salechart" type="bar" height="85" :options="chartOptions" :series="seriescolumnchart"> </apexchart>
            </div>
        </v-card-item>
    </v-card>
</template>
