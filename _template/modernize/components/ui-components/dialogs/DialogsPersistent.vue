    ...
    <div class="text-center">
        <v-dialog v-model="dialog" persistent class="dialog-mw">
            ...
            <v-card class="pa-6">
                ...
                <v-card-actions>
                    <v-spacer></v-spacer>
                    <v-btn color="green darken-1" variant="text" @click="dialog = false" flat> Disagree </v-btn>
                    <v-btn color="green darken-1" variant="text" @click="dialog = false" flat> Agree </v-btn>
                </v-card-actions>
            </v-card>
        </v-dialog>
    </div>
