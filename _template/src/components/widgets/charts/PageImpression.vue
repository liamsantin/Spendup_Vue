...
const chartOptions = computed(() => {
    return {
        ...
        colors: ['rgba(var(--v-theme-lightsecondary))', 'rgba(var(--v-theme-lightsecondary))', 'rgba(var(--v-theme-secondary))', 'rgba(var(--v-theme-lightsecondary))', 'rgba(var(--v-theme-lightsecondary))'],
        ...
        <v-card-item>
            ...
            <v-row>
                <v-col cols="5">
                    ...
                    <h6 class="text-subtitle-2 text-medium-emphasis">(Change Yesterday)</h6>
                    <div class="pt-2">
