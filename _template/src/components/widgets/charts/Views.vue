...
const chartOptions = computed(() => {
    return {
        ...
        colors: ['rgba(var(--v-theme-lightsecondary))', 'rgba(var(--v-theme-lightsecondary))', 'rgba(var(--v-theme-secondary))', 'rgba(var(--v-theme-lightsecondary))', 'rgba(var(--v-theme-lightsecondary))', 'rgba(var(--v-theme-lightsecondary))'],
