...
> Code : `src/features/auth/` + `components/auth/` + `app/guards/auth-guard.ts`  
> Statut : active · Relu : 2026-08-13  
> Voir aussi : `architecture/http.md`, `adr/0003-auth-cookie-mode.md`, `components/alert.md`  
> Backend : `Docs/Features/authentication/feature-authentification.md` (repo API)

Contrat front ↔ API pour `/api/auth/*` (et impacts session / step-up / devices).
...
- Détails routing / logo : `architecture/routing.md` ; alertes : `components/alert.md`.
