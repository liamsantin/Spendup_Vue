# Catalogue — composants shared

> Code : `src/components/shared/` · Preview : `/components` (dev only)  
> Relu : 2026-08-13
...
Ajouter ici une entrée + fichier `<kebab>.md` pour tout nouveau shared d’usage transverse.
