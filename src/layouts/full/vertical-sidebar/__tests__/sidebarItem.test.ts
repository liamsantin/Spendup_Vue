...
describe('themeIdFromPath', () => {
    ...
    it('mappe les finances, la gestion et les paramètres', () => {
        ...
        expect(themeIdFromPath('/app/gestion/tags')).toBe('gestion');
        ...
        expect(themeIdFromPath(SETTINGS_PATHS.privacy)).toBe('settings');
    ...
    it('liste les pages paramètres dans le thème settings', () => {
