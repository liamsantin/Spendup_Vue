...
import { ref } from 'vue';
import { ClockIcon, DownloadIcon, PlayerPauseIcon } from 'vue-tabler-icons';
...
<template>
    <v-row class="justify-center ma-n2">
        <v-col cols="12" md="9">
            <v-card elevation="10">
                <v-card-item>
                    <h4 class="text-h4">Préférences de notification</h4>
                    <div class="text-subtitle-1 text-medium-emphasis text-10 my-3">
                        Sélectionnez les notifications que vous souhaitez recevoir par e-mail. Notez que vous ne pouvez pas désactiver les
                        messages de service, tels que les notifications de paiement, de sécurité ou légales.
                    </div>
                    <div class="mt-6">
        ...
        <v-col cols="12" md="9">
            <v-card elevation="10">
                <v-card-item>
                    <v-card-title class="text-h4">Date &amp; heure</v-card-title>
                    <div class="text-subtitle-1 text-medium-emphasis text-10 my-3">
        ...
        <v-col cols="12" md="9">
            <v-card elevation="10">
                <v-card-item>
                    <v-card-title class="text-h4">Ignorer le suivi</v-card-title>
                    <div>
                        <div class="d-flex align-center mt-7">
                            <v-avatar size="48" class="mr-2" rounded="md" color="lightprimary">
