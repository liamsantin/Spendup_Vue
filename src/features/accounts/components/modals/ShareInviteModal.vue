...
import ShareInviteForm from '@/features/accounts/components/forms/ShareInviteForm.vue';
...
<template>
    ...
    >
        ...
        <template #footer="{ close }">
            ...
            <button type="button" class="su-btn su-btn--ink" :disabled="store.acting" @click="formRef?.submit()">
